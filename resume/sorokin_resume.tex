...
\newentry{\normalfont{2026.01 - 2028.05}}{\textbf{Postdoc in Statistics.} University of Chicago. Advisors \emph{Yuehaw Khoo and Lek-Heng Lim}.}
...
\newentry{\normalfont{2023.05 - 2023.08}}{\textbf{Graduate Intern} at \textbf{Los Alamos National Laboratory.} I modeled multifidelity solutions to PDE with random coefficients using efficient and error aware Gaussian processes regression models \cite{sorokin.gp4darcy}.}
...
% \newentry{\normalfont{2026}}{\textbf{SIAM Book}, Society for Industrial and Applied Mathematics (SIAM) book program.}
% \newentry{\normalfont{2026}}{\textbf{PMLR-ProbNum}, Proceedings of the First International Conference on Probabilistic Numerics.}
% \newentry{\normalfont{2026}}{\textbf{SINUM}, SIAM Journal of Numerical Analysis.}
