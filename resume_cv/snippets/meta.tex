...
\usepackage{eso-pic}
\AddToShipoutPictureFG*{%       % starred = first page only; drop * for every page
  \AtPageUpperLeft{%
    \raisebox{-.5cm}{%          % vertical offset from top edge
      \makebox[\paperwidth][r]{%
        \color{color1}\sffamily\bfseries\Large\doclabel\hspace*{.25cm}% right offset
      }%
    }%
  }%
}