...
\cvitem{\textbf{Frameworks}}{Python (pandas, PyTorch, GPyTorch), Julia, C, MATLAB, R, SQL} 
...
\cvitem{Summer 2021}{\textbf{Machine Learning Intern} at \textbf{SigOpt, an Intel Company}. I developed novel meta-learning techniques for model-aware hyperparameter optimization. As part of a six person ML engineering team, I contributed production code and learned key elements of the AWS stack. Resulted in publication of \citetitle{sorokin.sigopt_mulch}.}
